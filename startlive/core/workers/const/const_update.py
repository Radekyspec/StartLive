...
from startlive.core import constant
# package import
from startlive.core.app_state import dumps
from startlive.core.cache import get_cache_path
...
class ConstantUpdateWorker(BaseWorker):
    ...
    def run(self, report_progress: Callable | None, *args, **kwargs):
        ...
        url = "https://gh.bydfk.com/https://raw.githubusercontent.com/Radekyspec/StartLive/refs/heads/dev/startlive/resources/version.json"

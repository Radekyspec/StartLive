...
from startlive.core.constant import TitleStatus
from startlive.core.exceptions import TitleStatusError
...
class GetRoomContentAuditWorker(BaseWorker):
    ...
    def run(self, report_progress: Callable | None, *args, **kwargs):
        ...
        if response["data"] and response["data"]["title_audit_info"] and \
            ...
            app_state.room_info["title"] = response["data"]["title_audit_info"][
                "audit_title"]

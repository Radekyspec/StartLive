...
from startlive.core import app_state, constant
from startlive.core.constant import PreferProto, FaceAuthType
from startlive.core.exceptions import StartLiveError
from startlive.core.log import get_logger
from startlive.core.sign import livehime_sign, order_payload
...
class StartLiveWorker(BaseWorker):
    ...
    def parse_live_addr(response):
        prefer_proto = app_state.app_settings.get("prefer_proto",
                                                  PreferProto.RTMP)
        if prefer_proto == PreferProto.RTMP:
            app_state.stream_status.update({
